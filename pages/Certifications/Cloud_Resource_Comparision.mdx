...
| **Serverless Compute** | Lambda | Functions (aka Function Apps) |	Cloud Functions |
...
| **Mountable File Share** | EBS | SMB File Share | Cloud Filestore |
| **Data Pipeline** |  | Azure DataFactory | Cloud Data Fusion |
| **Managed Server Side Website Builder/Service** |	AWS Amplify | Azure Web App | App Engine |
